(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'klock'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'klock'.");
    }
    root.klock = factory(typeof klock === 'undefined' ? {} : klock, kotlin);
  }
  ...
  DateTimeSpan.prototype.times_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.DateTimeSpan.times_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (times) {
      return this.times_14dthe$(numberToDouble(times));
    };
  }));
  DateTimeSpan.prototype.div_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.DateTimeSpan.div_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (times) {
  ...
  DayOfWeek$Companion.prototype.get_za3lpa$ = function (index0) {
    return this.BY_INDEX0_0[index0];
  };
  ...
  KlockLocale$Companion.prototype.setTemporarily_rl52rq$ = defineInlineFunction('klock.com.soywiz.klock.KlockLocale.Companion.setTemporarily_rl52rq$', function (locale, callback) {
  ...
  var measureTime = defineInlineFunction('klock.com.soywiz.klock.measureTime_o14v8n$', wrapFunction(function () {
  ...
  var measureTimeWithResult = defineInlineFunction('klock.com.soywiz.klock.measureTimeWithResult_9ce4rd$', wrapFunction(function () {
  ...
  var get_years = defineInlineFunction('klock.com.soywiz.klock.get_years_s8ev3n$', wrapFunction(function () {
    var MonthSpan_init = _.com.soywiz.klock.MonthSpan;
    return function ($receiver) {
      return new MonthSpan_init(12 * $receiver | 0);
    };
  }));
  var get_months = defineInlineFunction('klock.com.soywiz.klock.get_months_s8ev3n$', wrapFunction(function () {
    var MonthSpan_init = _.com.soywiz.klock.MonthSpan;
    return function ($receiver) {
  ...
  MonthSpan.prototype.times_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.MonthSpan.times_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var numberToInt = Kotlin.numberToInt;
    var MonthSpan_init = _.com.soywiz.klock.MonthSpan;
    return function (times) {
  ...
  MonthSpan.prototype.div_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.MonthSpan.div_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var numberToInt = Kotlin.numberToInt;
    var MonthSpan_init = _.com.soywiz.klock.MonthSpan;
    return function (times) {
  ...
  var get_nanoseconds = defineInlineFunction('klock.com.soywiz.klock.get_nanoseconds_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  var get_microseconds = defineInlineFunction('klock.com.soywiz.klock.get_microseconds_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return TimeSpan.Companion.fromMicroseconds_14dthe$(numberToDouble($receiver));
  ...
  var get_milliseconds = defineInlineFunction('klock.com.soywiz.klock.get_milliseconds_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return TimeSpan.Companion.fromMilliseconds_14dthe$(numberToDouble($receiver));
  ...
  var get_seconds = defineInlineFunction('klock.com.soywiz.klock.get_seconds_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  var get_minutes = defineInlineFunction('klock.com.soywiz.klock.get_minutes_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  var get_hours = defineInlineFunction('klock.com.soywiz.klock.get_hours_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  var get_days = defineInlineFunction('klock.com.soywiz.klock.get_days_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  var get_weeks = defineInlineFunction('klock.com.soywiz.klock.get_weeks_rcaex3$', wrapFunction(function () {
    var TimeSpan = _.com.soywiz.klock.TimeSpan;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
  ...
  Moduler.prototype.double_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.internal.Moduler.double_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (count) {
      return this.double_14dthe$(numberToDouble(count));
    };
  }));
  Moduler.prototype.int_3p81yu$ = defineInlineFunction('klock.com.soywiz.klock.internal.Moduler.int_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var numberToInt = Kotlin.numberToInt;
    return function (count) {
  ...
  Kotlin.defineModule('klock', _);
  return _;
}));

//# sourceMappingURL=klock.js.map
